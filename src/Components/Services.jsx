...
const services = [
  {
    name: 'Fast Delivery',
    description: 'We provide fast and reliable delivery services for all your construction needs.',
  ...
  },
  {
    ...
    description: 'All our products are quality assured and meet industry standards.',
    icon: <FaShieldAlt size={40} className="text-blue-600" />
  },
  {
    name: 'Large Inventory',
    description: 'We have a large inventory to ensure availability of products when you need them.',
      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap -mx-4">
          {services.map((service) => (
            <div key={service.name} className="w-full md:w-1/2 lg:w-1/4 px-4 mb-8">
